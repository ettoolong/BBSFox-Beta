...
const mouseCursorMap = [
  'auto',                                                    // 0
  'url(chrome://bbsfox/skin/cursor/back.png) 0 6,auto',      // 1
  'url(chrome://bbsfox/skin/cursor/pageup.png) 6 0,auto',    // 2
  'url(chrome://bbsfox/skin/cursor/pagedown.png) 6 21,auto', // 3
  'url(chrome://bbsfox/skin/cursor/home.png) 0 0,auto',      // 4
  'url(chrome://bbsfox/skin/cursor/end.png) 0 0,auto',       // 5
  'pointer',                                                 // 6
  'default',                                                 // 7
  'url(chrome://bbsfox/skin/cursor/prevous.png) 6 0,auto',   // 8
  'url(chrome://bbsfox/skin/cursor/next.png) 6 0,auto',      // 9
  'url(chrome://bbsfox/skin/cursor/first.png) 0 0,auto',     // 10
  'auto',                                                    // 11
  'url(chrome://bbsfox/skin/cursor/refresh.png) 0 0,auto',   // 12
  'url(chrome://bbsfox/skin/cursor/last.png) 0 0,auto',      // 13
  'url(chrome://bbsfox/skin/cursor/last.png) 0 0,auto'       // 14
];
...
TermBuf.prototype={
    ...
    puts: function(str) {
        if(!str)
            return;
        if(this.view && this.view.conn && this.prefs.charset == 'UTF-8')
    ...
    updateCharAttr: function() {
        ...
        for(var row=0; row<rows; ++row) {
            ...
            if(needUpdate) { // this line has been changed
                ...
                if(this.view.bbscore.robot.autoLoginStage > 0)
    ...
    SetPageState: function() {
      ...
      if( this.IsUnicolor(0, 0, cols/2 - 11) && this.IsUnicolor(0, cols/2 + 20, cols-10) ) {
        ...
        if(this.IsUnicolor(2, 0, cols-10) && !this.isLineEmpty(1) && (this.cur_x<19 || this.cur_y==rows-1)) {
          ...
          if(this.prefs.testPttThread && this.isPttThread())
            threadState = 1;
        } else {
